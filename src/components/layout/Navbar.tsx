    ...
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white shadow-sm backdrop-blur dark:border-blue-900 dark:bg-slate-950 dark:shadow-lg dark:shadow-black/40">
      <Container>
        ...
        >
          <a
            href="#home"
            className="rounded-md px-2 py-1 text-lg font-extrabold text-slate-950 transition hover:text-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none dark:text-white dark:hover:text-blue-300 dark:focus:ring-offset-slate-950"
          >
            Derek Konadu
          </a>
          ...
          <div className="flex items-center gap-3 lg:hidden">
            ...
            <button
              ...
              className="rounded-lg border border-slate-300 px-3 py-2 text-sm font-bold text-slate-800 transition hover:bg-slate-100 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none dark:border-slate-600 dark:text-white dark:hover:bg-blue-500/20 dark:focus:ring-offset-slate-950"
            >
              {isOpen ? "Close" : "Menu"}
            </button>
          </div>
